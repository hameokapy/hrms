...
<html>
    <head>
        ...
        <style>
            ...
            .error-code { font-size: 10rem; line-height: 1; color: #dc3545; opacity: 0.15; }
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <h1 class="error-code fw-bold mb-0">500</h1>
                    <h2 class="h3 mb-3 fw-bold text-dark">Internal Server Error</h2>
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-2">
                        ...
                        <a href="${pageContext.request.contextPath}/home" class="btn btn-danger px-4 py-2 text-white shadow-sm">
